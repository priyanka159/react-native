...
class Home extends Component {
  constructor(props) {
    ...
    this.state = {
        ...
        selected:'',
        selCard:'',
      cropsIntial : [{crop : "oninon", selected : false},
      {crop : "potato", selected : false},
      {crop : "tomatoq", selected : false},],
        crop:[],
        count:0,
  ...
  <Picker
            ...
            >
              ...
              <Picker.Item label="Wheat" value="Wheat" /> */}
              {
                ...
                return (
                 !crop.selected && (
                 <Picker.Item label = {crop.crop} value = {crop.crop}>{crop.crop}</Picker.Item>
                 )
                )
                })
              }
